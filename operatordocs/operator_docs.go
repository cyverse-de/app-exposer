// Package operatordocs Code generated by swaggo/swag. DO NOT EDIT
    ...
    "paths": {
        "/analyses": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "The analysis bundle to launch",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/analyses/{analysis-id}/backchannel-logout": {
            "post": {
                ...
                "description": "Forwards a Keycloak logout_token to the vice-proxy sidecar,\ninvalidating the session identified in the token. This is called\nautomatically by Keycloak when a user logs out from another\napplication in the same SSO realm — callers should not invoke\nthis directly. Use POST /logout-user to kick a specific user,\nor POST /logout to initiate a browser-facing logout flow.",
                "consumes": [
        ...
        "/analyses/{analysis-id}/logout": {
            "post": {
                ...
                "description": "Clears the user's vice-proxy session cookie and returns the\nKeycloak logout redirect URL. The caller (typically a browser\nor UI) should redirect the user to this URL to complete the\nSSO logout. Affects only the session associated with the\nrequest's cookie — use POST /logout-user to target a specific\nuser by username without needing their cookie.",
                "produces": [
                    "application/json"
                ],
                "tags": [
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/operator.StatusResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
