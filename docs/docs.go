    ...
    "definitions": {
        ...
        "httphandlers.AnalysisLaunch": {
            ...
            "properties": {
                ...
                "extra": {
                    "$ref": "#/definitions/model.ExtraInfo"
                },
                "failure_count": {
                    "type": "integer"
                },
        ...
        "model.Container": {
            ...
            "properties": {
                ...
                "container_volumes_from": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.VolumesFrom"
                    }
                },
                "cpu_shares": {
                    "type": "integer"
                ...
                "interactive_apps": {
                    "$ref": "#/definitions/model.InteractiveApps"
                },
                "max_cpu_cores": {
        ...
        "model.ExtraInfo": {
            ...
            "properties": {
                "htcondor": {
                    "$ref": "#/definitions/model.HTCondorExtraInfo"
                }
            }
        },
        "model.FileMetadata": {
        ...
        "model.Step": {
            ...
            "properties": {
                "component": {
                    "$ref": "#/definitions/model.StepComponent"
                },
                "config": {
                    "$ref": "#/definitions/model.StepConfig"
                },
                "environment": {
                    "$ref": "#/definitions/model.StepEnvironment"
                },
                "input": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.StepInput"
                    }
                },
                "log-file": {
                    "type": "string"
                ...
                "output": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.StepOutput"
                    }
                },
                "stderr": {
                    "type": "string"
        ...
        "model.StepConfig": {
            ...
            "properties": {
                ...
                "params": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.StepParam"
                    }
                }
            }
        },
